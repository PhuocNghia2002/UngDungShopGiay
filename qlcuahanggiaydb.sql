...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 01, 2023 lúc 06:02 PM
...
('KH1', 'Nguyễn Tuấn', 'Anh', 'Nam', '123321123321 địa chỉ', 'nguyenanh@gmail.com', 'vip', 59489.3),
...
('KH4', 'Nguyễn Đào', 'Kim', 'Nữ', '1231 địa chỉ', 'khoeghe@gmail.com', 'bình thường', 53751),
('KH5', 'Trần Lê Anh', 'Đào', 'Nữ', '23213 địa chỉ', 'daotran@gmail.com', 'bình thường', 1670),
...
('KM7', 'đào lửa', 'Loại 2', 'đặc biệt', '25 Jul 2023', '25 Jul 2023');
...
('PN005', 'NCC3', 'admin', '25 Jul 2023', 7500),
('PN006', 'NCC1', 'admin', '25 Jul 2023', 1200);
...
('SP1', 'SuperStar', 8, 200, 29, 'Nam', 'Vải', '3', 'US', 'WT', 'AD'),
('SP2', 'Dép tổ ong', 2, 200, 40, 'Nam', 'Vải', '2', 'VN', 'BLK', 'TO'),
('SP3', 'Giày tàng hình', 9, 150, 40, 'Tất cả', 'NanoGen', '3', 'US', 'WT', 'BT'),
('SP4', 'Ngàn sao', 3, 50, 35, 'Nữ', 'Nilon', '5', 'CN', 'BLU', 'NK'),
('SP5', 'Guốc', 10, 150, 34, 'Nữ', 'Vải', '3', 'ID', 'GR', 'NK'),
('SP6', 'Dép Lê', 13, 550, 40, 'Nam', 'Cây cỏ', '3', 'ID', 'ORG', 'BT'),
('SP7', 'Giày Cao Gót', 19, 550, 34, 'Nữ', 'Gỗ cẩm lai', '1', 'VN', 'ORG', 'TO');
